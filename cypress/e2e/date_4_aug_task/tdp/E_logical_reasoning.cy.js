...
describe('Logical Reasoning', () => {
    it('Logical Reasoning test', () => {
        ...
        cy.get('.card-pink > :nth-child(1) > .justify-content-between > .col > .row > .col-auto > .status-tag')
            .should('have.text', 'Not Started')
        cy.get('.card-pink > :nth-child(1) > .justify-content-between > .col > .row > .col-auto > .status-tag')
            .should('not.have.text', 'In Progress')

        //status of start/continue button
        cy.get('.card-pink > :nth-child(1) > .justify-content-between > .col-md-auto > .btn')
        ...
        // Logical Reasoning test assertion
        cy.get('.card-yellow')
            .should('be.visible')
