...
describe('TDP test', () => {
    it('Linguistics test', () => {
        ...
        cy.get('.card-purple > :nth-child(1) > .justify-content-between > .col > .row > .col-auto > .status-tag')
            .should('have.text', 'Not Started')
        cy.get('.card-purple > :nth-child(1) > .justify-content-between > .col > .row > .col-auto > .status-tag')
            .should('not.have.text', 'In Progress')

        //status of start/continue button
        cy.get('.card-purple > :nth-child(1) > .justify-content-between > .col-md-auto > .btn')
