...
describe('Aptitude Test', () => {
    it('Aptitude test with assertions', () => {
        ...
        cy.get('.card-blue > :nth-child(1) > .justify-content-between > .col > .row > .col-auto > .status-tag')
            .should('have.text', 'Not Started')
        cy.get('.card-blue > :nth-child(1) > .justify-content-between > .col > .row > .col-auto > .status-tag')
            .should('not.have.text', 'In Progress')

        //status of start/continue button
        cy.get('.card-blue > :nth-child(1) > .justify-content-between > .col-md-auto > .btn')
